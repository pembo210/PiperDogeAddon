...
class Tab4(tk.Frame):
	def __init__(self, root):
		...
		tk.Radiobutton(coinTypeFrame, text="Bitcoin", variable=self.coinType, value="bitcoin").pack(side=tk.LEFT, padx=10, pady=10)
		tk.Radiobutton(coinTypeFrame, text="Litecoin", variable=self.coinType, value="litecoin").pack(side=tk.LEFT, padx=10, pady=10)
		...
		tk.Label(self, text="Address prefix must begin with 1 for bitcoin and L for litecoin or key generation will fail.").pack(padx=10)
